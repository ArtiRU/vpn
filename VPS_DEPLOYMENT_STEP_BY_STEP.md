...
docker compose -f /opt/vpn-backend/docker-compose.full.yml logs -f
```
...
**Логи:** `docker compose -f /opt/vpn-backend/docker-compose.full.yml logs -f`

**Статус:** `docker compose -f /opt/vpn-backend/docker-compose.full.yml ps`
